...
HereTileLayer.HERE = L.TileLayer.extend({
  ...
  initialize: function initialize(options) {
    ...
    var path =
      '/{resource}/2.1/{resource2}/{mapId}/{scheme}/{z}/{x}/{y}/{tileResolution}/{format}?apiKey={appCode}&congestion'
    var attributionPath =
      '/maptile/2.1/copyright/{mapId}?apiKey={appCode}'
    ...
    if (options.scheme.indexOf('.traffic.') !== -1) {
      tileServer = 'traffic.ls.hereapi.com'
    }
